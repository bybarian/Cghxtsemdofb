      ...
      <div className="fixed inset-0 z-[100] bg-[#fdfdfd] flex flex-col font-sans select-none overflow-hidden">
        ...
        <div className="bg-cathay-green text-white p-6 flex items-center justify-between shadow-2xl relative z-10">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3 bg-white p-2 md:p-2.5 rounded-[1.5rem] md:rounded-[2rem] shadow-xl ring-1 ring-black/5">
              <div className="flex items-center gap-2">
                ...
                <div className="bg-[#f0f9f4] text-cathay-green px-2.5 py-1 rounded-xl text-[10px] font-black ring-1 ring-cathay-green/10">CGH</div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="bg-[#f1f5f9] text-slate-800 px-2.5 py-1 rounded-xl text-[10px] font-black ring-1 ring-slate-200">TSEM</div>
              </div>
            </div>
            <div>
